    ...
    <div class="container">
        <div class="row">
                ...
                <form @reset.prevent="resetar">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <small class="text-muted">Formato: 11 9 4002-8922</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Placa do Veículo Mercosul:</label>
                        <div class="col">
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color:'+form.cor+'!important'">
                ...
                <div class="mb-3 row">
                    <span>Placa do Veículo Mercosul: {{ form.placaVeiculoMercosul }}</span>
                </div>
                <div class="mb-3 row">
...
export default {
    ...
    data: () => ({
        cursos: [
            ...
            {id: 3, curso: 'Curso Completo do Desenvolvedor NodeJS e MongoDB'}
        ],
        form: {
            //moment: {},
            nome: '',
    ...
    methods: {
        ...
        enviar(e) {
            ...
            //retorna uma promise que vai nos permitir tomar ações se a requisição deu certo ou errado
        },
        resetar() {
            this.form = {}
        }
